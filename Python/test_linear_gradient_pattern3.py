...
class Test1_LinearGradient1:
    ...
    def test_linear_gradient(self) -> List[str]:
        ...
        # ここからパターンの定義
        # ここからパターンスタート
        pattern_id = "linear_gradient_pattern3"
        start_location_data = Vector2(0, 0)
        size_data = Vector2(0.25, 0.25)
        ...
        linear_gradient_id = "linear_gradient3"
    ...
    def svg_data_build(self):
        ...
        file_name = "test_pattern_svg/svg/test1_linear_gradient_pattern3"
